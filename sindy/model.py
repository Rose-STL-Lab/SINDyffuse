...
class TextToXi(nn.Module):
    """Text→Xi with pre-norm residual trunk, dropout, and per-frame positional encoding."""
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList(
            [
                _PreNormResidualBlock(int(hidden_dim), self.dropout_p, self.ff_mult)
