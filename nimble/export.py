...
def patch_b3d_moco(b3d_path: str | Path, *, trial_name: str, act_cfg: MuscleActivationConfig, ik_manifest_status: str | None=None, ik_stats: Dict[str, Any] | None=None, tracking_gate_cfg: CoordinateTrackingGateConfig | None=None) -> Tuple[Dict[str, float], int, Dict[str, str], str]:
