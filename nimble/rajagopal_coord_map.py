...
RAJAGOPAL_NIMBLE_DOF_NAMES: Tuple[str, ...] = ('ground_pelvis_0', 'ground_pelvis_1', 'ground_pelvis_2', 'ground_pelvis_3', 'ground_pelvis_4', 'ground_pelvis_5', 'hip_r_0', 'hip_r_1', 'hip_r_2', 'walker_knee_r_0', 'ankle_r_0', 'subtalar_r_0', 'mtp_r_0', 'hip_l_0', 'hip_l_1', 'hip_l_2', 'walker_knee_l_0', 'ankle_l_0', 'subtalar_l_0', 'mtp_l_0', 'back_0', 'back_1', 'back_2', 'acromial_r_0', 'acromial_r_1', 'acromial_r_2', 'elbow_r_0', 'radioulnar_r_0', 'radius_hand_r_0', 'radius_hand_r_1', 'acromial_l_0', 'acromial_l_1', 'acromial_l_2', 'elbow_l_0', 'radioulnar_l_0', 'radius_hand_l_0', 'radius_hand_l_1')
NIMBLE_TO_OPENSIM_COORD: Dict[str, str] = {'ground_pelvis_0': 'pelvis_tilt', 'ground_pelvis_1': 'pelvis_list', 'ground_pelvis_2': 'pelvis_rotation', 'ground_pelvis_3': 'pelvis_tx', 'ground_pelvis_4': 'pelvis_ty', 'ground_pelvis_5': 'pelvis_tz', 'hip_r_0': 'hip_flexion_r', 'hip_r_1': 'hip_adduction_r', 'hip_r_2': 'hip_rotation_r', 'walker_knee_r_0': 'knee_angle_r', 'ankle_r_0': 'ankle_angle_r', 'subtalar_r_0': 'subtalar_angle_r', 'mtp_r_0': 'mtp_angle_r', 'hip_l_0': 'hip_flexion_l', 'hip_l_1': 'hip_adduction_l', 'hip_l_2': 'hip_rotation_l', 'walker_knee_l_0': 'knee_angle_l', 'ankle_l_0': 'ankle_angle_l', 'subtalar_l_0': 'subtalar_angle_l', 'mtp_l_0': 'mtp_angle_l', 'back_0': 'lumbar_extension', 'back_1': 'lumbar_bending', 'back_2': 'lumbar_rotation', 'acromial_r_0': 'arm_flex_r', 'acromial_r_1': 'arm_add_r', 'acromial_r_2': 'arm_rot_r', 'elbow_r_0': 'elbow_flex_r', 'radioulnar_r_0': 'pro_sup_r', 'radius_hand_r_0': 'wrist_flex_r', 'radius_hand_r_1': 'wrist_dev_r', 'acromial_l_0': 'arm_flex_l', 'acromial_l_1': 'arm_add_l', 'acromial_l_2': 'arm_rot_l', 'elbow_l_0': 'elbow_flex_l', 'radioulnar_l_0': 'pro_sup_l', 'radius_hand_l_0': 'wrist_flex_l', 'radius_hand_l_1': 'wrist_dev_l'}
OPENSIM_COUPLED_BETA_FROM_KNEE: Dict[str, str] = {'knee_angle_r_beta': 'knee_angle_r', 'knee_angle_l_beta': 'knee_angle_l'}
...
def build_moco_states_table_processor(mot_path: str | Path, *, lowpass_hz: float=6.0) -> osim.TableProcessor:
...
def write_coordinates_mot(q: np.ndarray, mot_path: str | Path, *, fps: float, mapping: RajagopalCoordMapping | None=None) -> Path:
    path = Path(mot_path)
