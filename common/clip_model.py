"""Safe CLIP model loading for single- and multi-GPU training."""
...
def clip_download_root() -> Path:
    """Persistent CLIP weight cache (shared PVC path by default)."""
...
def _clip_weight_path(model_name: str, download_root: Path) -> Path:
    import clip.clip as clip_core  # type: ignore
...
def load_clip(
    ...
    *,
    ...
    """Load CLIP with rank-0-first download to avoid DDP cache corruption."""
    import clip  # type: ignore
